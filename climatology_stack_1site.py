...
sns.pointplot(
    ...
    color=site_colors, marker=None, linewidth=1.5, zorder=10
)
ax.set_xticklabels('')
ax.set_xlabel('')
...
sns.pointplot(
    ax=ax, x=oipc_qpt.month, y=oipc_qpt.d2h,
    legend=False, linewidth=1.5, color=site_colors, markers='', zorder=10
)
...
sns.boxplot(
    ax=ax, x=precip_qpt_plot.month, y=(precip_qpt_plot.precip)*1000,
    color=site_colors, fliersize=3
